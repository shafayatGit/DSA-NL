...
console.log(nameSet); // --> Set(3) { { name: 'Alice' }, { name: 'Bob' }, { name: 'Charlie' } } like key-value pair
console.log(nameSet.size); // --> 3

nameSet.delete(Bob); // delete Value(Bob) from the Set
console.log(nameSet); // --> Set(2) { { name: 'Alice' }, { name: 'Charlie' } }

nameSet.clear();
console.log(nameSet); // --> Set(0) {}  